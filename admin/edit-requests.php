        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    if (isset($_GET['id'])) {
                        $user_id = $_GET['id'];
                        $users = "SELECT * FROM needed WHERE id='$user_id' ";
                                ...
                                <form action="update-request.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="patient_name" value="<?= $user['patient_name']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Blood Group</label>
                                            <input type="text" name="blood_group" value="<?= $user['required_blood_group']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
